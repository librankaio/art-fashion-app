...
<body style="font-family: Open Sans;">
    <div style="margin-left: 0%; margin-right: 0%;">
        <h5 class="split-para" style="margin: 0px auto; text-align:left; padding-bottom: 1px;" id="text_code"><span>
                <h5 style="margin: 0px auto; float:right; font-size:15px">Art Fashion Jewelry <br>Telp.(021) 6403172 /
        ...
        <div class="row pt-4">
            ...
            <div class="col-6 d-flex justify-content-end align-items-end">
                <table id="mytable" border="1px">
                    <thead>
                        <tr>
                            <td class="p-2" style="width: 200px; word-wrap: break-word; font-size:13px;">From :
                                {{ $treturh->counter_from }}<br></td>
                        </tr>
                        <tr>
                            <td class="p-2" style="width: 200px; word-wrap: break-word; font-size:13px;">To :
                                {{ $treturh->counter }}<br> </td>
                        </tr>
                        <tr>
                            <td class="p-2" style="width: 200px; word-wrap: break-word; font-size:13px;">Alamat :
                                {{ $address->alamat }}<br> </td>
                        </tr>
                    </thead>
                </table>
            </div>
            ...
            <table id="mytable" border="0.5px" style="border:solid;">
                ...
                <tbody>
                    ...
                    @for ($i = 0; $i < sizeof($treturds); $i++)
                        @php $counter++; @endphp <tr>
                            <td align="center" style="width: 105px; word-wrap: break-word;">{{ $counter }}</td>
                            <td align="center" style="width: 250px; word-wrap: break-word;">
                                {{ strtok($treturds[$i]->code, ' ') }}
                            </td>
                            <td align="center" style="width: 140px; word-wrap: break-word;">{{ $treturds[$i]->name }}
                            </td>
                            <td align="center" style="width: 105px; word-wrap: break-word;">{{ $treturds[$i]->warna }}
                            </td>
                            <td align="center" style="width: 60px; word-wrap: break-word;">
                                {{ number_format($treturds[$i]->qty, 0, '.', '') }}</td>
                            <td align="center" style="width: 105px; word-wrap: break-word;">{{ $treturds[$i]->satuan }}
                            </td>

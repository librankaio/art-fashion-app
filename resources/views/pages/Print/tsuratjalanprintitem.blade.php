...
@foreach($items as $item)
  ...
  <div class="container" style="padding-bottom: 5px;">
    ...
    <h5 class="split-para" style="margin: 0px auto; font-size: 6px; text-align:left; padding-bottom: 2px;" id="text_code">{{ $item->name_lbl }} <span><h5 style="margin: 0px auto; font-size: 6px; float:right;">{{ $item->warna }}</h5></span></h5>

...
@foreach($items as $item)
  ...
  <div class="container" style="padding-bottom: 15px;">
    ...
    <h5 class="split-para" style="margin: 0px auto; font-size: 8px; text-align:left; margin-top: -5px" id="text_code">{{ $item->code }} <span><h5 style="margin: 0px auto; font-size: 6.5px; float:right; font-weight: bold;">RP. {{ number_format($item->hrgjual, 2, '.', ',') }},-</h5></span></h5>

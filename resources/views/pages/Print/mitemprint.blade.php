...
<body>
  <div class="container" style="padding-bottom: 7px;">
    ...
    <h1 class="split-para" style="margin: 0px auto; font-size: 6px; text-align:left; margin: 0px auto;" id="text_code">{{ $mitem->code }} <span><h1 style="margin: 0px auto; font-size: 6px; float:right; margin: 0px auto;">{{date("mY")}}</h1></span></h1>

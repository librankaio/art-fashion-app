...
<body>
  <div class="container" style="padding-bottom: 15px;">
    ...
    <h5 class="split-para" style="margin: 0px auto; font-size: 6.5px; text-align:left; margin-top: -5px" id="text_code">{{ $mitem->code }} <span><h5 style="margin: 0px auto; font-size: 6.5px; float:right; font-weight: bold;">RP. {{ number_format($mitem->hrgjual, 2, '.', ',') }},-</h5></span></h5>
  </div>

                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="mlokasi" id="mlokasi">
                                            <option disabled selected>--Select Counter--</option>
                                            <option>Gudang Matahari</option>
                                            <option>Gudang Bulan</option>
                                            <option>Gudang Pluto</option>
                                            <option>Gudang Mars</option>
                                        </select>
                                    </div>
                                    <div class="form-group">

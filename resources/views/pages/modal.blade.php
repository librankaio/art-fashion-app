        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-6">
                ...
                <div class="card card-mt">
                    ...
                    <div class="card-body">
                        <p class="mb-2">You can easily change the default browser confirmation box with a bootstrap
                            modal.</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="mb-2">Use the Bootstrap method to create modal. You need to create an HTML structure
                            for modal and the following button will trigger it.</p>
            ...
            <div class="col-12 col-md-6 col-lg-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="mb-2">Check the <code>modal.js</code> code in the <code>dist/js/page</code> folder to

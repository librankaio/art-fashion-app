...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a class="text-muted">Laporan Stock Overview</a></div>
        </div>
    </div>
    @php
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex justify-content-end">                    
                                <div class="form-group">
                                    <button class="btn btn-primary mr-1" id="confirm" type="submit" formaction="/rstockoverviewsearch" onclick="show_loading()">View</button>
                                </div>                                
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row pb-3">
                            ...
                            <div class="col-6 d-flex justify-content-end">
                                <button type="submit" formaction="rstockoverviewexcl" formtarget="_blank" class="btn btn-success"><i

                                    ...
                                    <div class="col-md-12 d-flex justify-content-end">
                                        <div class="form-group">
                                            <button class="btn btn-primary mr-1" id="confirm" type="submit"
                                                formaction="/romsetcountersearch" onclick="show_loading()">View</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row pb-3">
                                    ...
                                    <div class="col-6 d-flex justify-content-end">
                                        <button type="submit" formaction="romsetcounterexcl" formtarget="_blank"
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="datatable">
                                        ...
                                        <tbody>
                                            ...
                                            @isset($results)
                                                @php
                                                    $grouped = collect($results)->groupBy('counter');
                                                    $no = 1;
                                                @endphp

                                                @foreach ($grouped as $counter => $items)
                                                    @php

...
<section class="section">
    <div class="section-header">
        <h1>Upload Data Tambah Stock</h1>
                ...
                <div class="card">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <a class="text-decoration-none"
                                          href="{{ asset('../assets/template/tambah_stock_upload.xlsx') }}">
                                          Download Template Upload Tambah Stock Item
                        ...
                        <div class="card-footer text-right">                            
                            ...
                            formaction="{{ route('uploadtbhstockpost') }}" id="confirm">Upload</button> 
                        </div>
                    </form>
                </div>
            </div>            

                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered" id="datatable">
                                ...
                                <tr row_id="{{ $counter }}">
                                    ...
                                    <td class="border border-5"><input style='width:120px;' readonly form='thisform' class='idclass form-control' name='id_d[]' type='text' value='{{ $tpenerimaands[$i]->id }}' id="tbl_detail_id_{{ $counter }}"></td>
                                    ...
                                    <td class="border border-5"><input style='width:120px;' readonly form='thisform' class='existdbclass form-control' name='existdb_d[]' type='text' value='{{ $tpenerimaands[$i]->id }}' id="existdb_{{ $counter }}"></td>
                                </tr>                               
                                @endfor
                                </tbody>                             
                            </table>

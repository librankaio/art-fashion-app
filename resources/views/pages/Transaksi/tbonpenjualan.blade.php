                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            @if (session('privilage') != 'ADM' && session('privilage') != 'SPG DS')
                                                ...
                                                <button class="btn btn-primary mr-1" id="clear_payment2"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="totbayar"
                                                        form="thisform" id="totbayar" value="0">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="totbayar_2"
                                                        form="thisform" id="totbayar_2" value="0" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="totkembali"
                                                        form="thisform" id="totkembali" value="0" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="price_disc"
                                                        form="thisform" id="price_disc" value="0" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="price_total"
                                                        form="thisform" id="price_total" value="0" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-3" hidden>
                                                <div class="form-group">
                                                    <label>Today Saldo</label>
                                                    <input type="text" class="form-control" name="today_saldo"
                                                        form="thisform" id="today_saldo" value="{{ $today_saldo }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-3" hidden>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="price_sebelumdisc"
                                                        form="thisform" id="price_sebelumdisc" value="0" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-3" hidden>
                                                <div class="form-group">
                        ...
                        <div class="card-footer text-right">
                            ...
                            @elseif(session('privilage') == 'SPG DS')
                                <a class="btn btn-warning mr-1" href="/tbonjuallist">List</a>
                                <button class="btn btn-primary mr-1" id="confirm" type="submit"
                                    formaction="{{ route('tbonjualpost') }}">Save</button>
                            @else
                                {{-- <a class="btn btn-warning mr-1" id="modal-list" onclick="filterlist()">List</a> --}}
                                <a class="btn btn-warning mr-1 text-light" id="modal-list"
                                    onclick="filterlist()">List</a>
                                <button class="btn btn-primary mr-1" id="confirm" type="submit"
                                    formaction="{{ route('tbonjualpost') }}">Save</button>
                            @endif
                            {{-- @if ($tpos_save == 'Y')
            ...
            <span aria-hidden="true">&times;</span>
                ...
                <form action="{{ route('msaldoawalpost') }}" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-primary mr-1" type="submit" id="confirm_modal"
        ...
        $(document).ready(function() {
            ...
            $(document).on("click", "#addItem", function(e) {
                ...
                tablerow = "<tr row_id=" + counter_row + " id='row_" + counter_row +
                    "'><th style='readonly:true;' row_th=" + counter_row +
                    " class='border border-5'>" + counter +
                    ...
                    thousands_separators(subtot) + "' name='subtot_d[]' id='subtot_d_" +
                    counter_row +
                    "'></td><td class='border border-5' style='display:none;'><input style='width:120px;' readonly form='thisform' class='subtotoldclass form-control' type='text' value='" +
                    thousands_separators(subtot) + "' id='subtotold_d_" + counter_row +
                    "'></td><td class='border border-5'><input type='text' readonly form='thisform' style='width:100px;' class='hrgsetdiscclass form-control' value='" +
            ...
            $(document).on("click", ".delete", function(e) {
                ...
                if (r == true) {
                    ...
                    $('#price_sebelumdisc').val(thousands_separators(totsebelumdisc_new.toFixed(
                        2)));

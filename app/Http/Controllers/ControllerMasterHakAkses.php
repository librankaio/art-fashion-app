...
class ControllerMasterHakAkses extends Controller
{
    ...
    public function getedit(Mhakakses $mhakakses){
        $counters = Mcounter::select('id','code','name')->get();
        $users = User::select('id','nik','name')->get();
        $hakakses_user = Mhakakses::select('id','id_user','nik','counter')->where('id_user', '=', $mhakakses->id)->first();
        // dd($hakakses_user);
        $auth_mitem = Mhakakses::where('id_user', '=', $mhakakses->id)->where('feature', '=', 'mitem')->first();
        $auth_muser = Mhakakses::where('id_user', '=', $mhakakses->id)->where('feature', '=', 'muser')->first();
        $auth_mwarna = Mhakakses::where('id_user', '=', $mhakakses->id)->where('feature', '=', 'mwarna')->first();
        $auth_mcounter = Mhakakses::where('id_user', '=', $mhakakses->id)->where('feature', '=', 'mcounter')->first();
        $auth_mhakses = Mhakakses::where('id_user', '=', $mhakakses->id)->where('feature', '=', 'mhakses')->first();
        $auth_tsob = Mhakakses::where('id_user', '=', $mhakakses->id)->where('feature', '=', 'tsob')->first();
        $auth_tpenerimaan = Mhakakses::where('id_user', '=', $mhakakses->id)->where('feature', '=', 'tpenerimaan')->first();
        $auth_tretur = Mhakakses::where('id_user', '=', $mhakakses->id)->where('feature', '=', 'tretur')->first();
        $auth_tbonjual = Mhakakses::where('id_user', '=', $mhakakses->id)->where('feature', '=', 'tbonjual')->first();
        $auth_tadjstock = Mhakakses::where('id_user', '=', $mhakakses->id)->where('feature', '=', 'tadjstock')->first();
        $auth_tsuratjalan = Mhakakses::where('id_user', '=', $mhakakses->id)->where('feature', '=', 'tsuratjalan')->first();
        $auth_tstopname = Mhakakses::where('id_user', '=', $mhakakses->id)->where('feature', '=', 'tstopname')->first();
        $auth_tbelibrg = Mhakakses::where('id_user', '=', $mhakakses->id)->where('feature', '=', 'tbelibrg')->first();
        // dd($auth_mitem);
    ...
    public function update(Mhakakses $mhakakses){
        $user = Mhakakses::select('id','id_user','nik','counter')->where('id','=', $mhakakses->id_user)->first();
